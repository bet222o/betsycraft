...
content_html = """
      ...
      <div style="display:flex; align-items:flex-start; gap:10px; margin:1.5rem 0;">
        ...
        <div style="width:50%; aspect-ratio:1.294;">
          <img src="/images/speaking/Heather-Edney.png"
               alt="A collage of harm reduction educational materials from the Santa Cruz Needle Exchange Program, including flyers on safer use practices, syringe basics, wound care, and wellness programs, beneath a header reading 'Heather Edney' and a biographical quote about her founding role in the program."
      ...
      <ul>
        ...
        <li><strong>Health Humanities and Ethics Graduate Certificate Program
        (CU).</strong> Invited lecture, &ldquo;What is our role?
        Incarceration and Reflections on Well-Being&rdquo; (Instructor: Dr.
        Kate LeMasters).</li>
      </ul>

      <h2>Selected 2024 talks</h2>
      <ul>
        <li><strong>County Sheriffs of Colorado Fall Conference &middot;
        Broomfield, CO.</strong> &ldquo;Advancing Peer Support in Colorado
        County Jails.&rdquo;</li>

        <li><strong>Drug Policy Alliance Webinar.</strong> &ldquo;Clearing
        the Path for Overdose Prevention Centers in the United
        States.&rdquo;</li>

        <li><strong>Conference for Interdisciplinary Drug and Alcohol
        Research &middot; UCCS.</strong> &ldquo;Qualitative Research and
        Creative Community Engagement&rdquo; (workshop, with Hagerman,
        Conzelman, Otañez).</li>
      </ul>

      <h2>Exhibits &amp; creative dissemination</h2>
      <ul>
        <li><strong>High Walls Exhibit &middot; Redline Contemporary Art
        Center, Denver (2025).</strong> Incarceration, Mental Health, and
        Substance Use: A Photovoice Project.</li>

        <li><strong>ACT [Active Collective Trauma] Summit 2025 &middot;
        Aurora, CO.</strong> &ldquo;Zine-making: Art as a Form of Resistance
        and Healing&rdquo; (workshop, with Otañez and Baranauskas).</li>

        <li><strong>13th National Harm Reduction Conference &middot; San
        Juan, PR (2022).</strong> &ldquo;Visualizing Harm Reduction, Stigma
        Reduction and Overdose Prevention: A Video Storytelling
        Workshop&rdquo; (with Otañez and Guerrero).</li>
      </ul>"""
[[extra.content_blocks]]
block = "newsletter"
